      ...
      <div class="row">
        ...
        <div class="container-fluid main" id="model">
          <div class="row row-cols-1 row-cols-md-4 row-cols-sm-3 row-cols-xxl-5">
            ...
            $model = mysqli_query($koneksi,"SELECT * FROM model WHERE model_kategori=$kategori_id ORDER BY model_id ASC");
            ...
            <div class="col-lg-3">
              <div class="card shadow">
                ...
                <div class="card-body">
                  ...
                  <a href="pemesanan_kategori.php" class="btn btn-secondary">Pesan</a>
                </div>
              </div>
            </div>
            <?php } ?>
